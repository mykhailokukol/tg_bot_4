...
async def residence(
    ...
    try:
        ...
        info = "Данные ФИО не найдены. Проверьте, пожалуйста, на корректность отправленные данные и повторите запрос в разделе «Проживание» или свяжитесь с организатором. Телефоны организаторов в разделе «Контакты организаторов»"
